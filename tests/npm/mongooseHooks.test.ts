...
// describe('argument', () => {
// 	// it('should delete a specific argument from array of Arguments in command model after the argument is deleted', async(done) => {
// 	// 	expect.assertions(3)
// 	// 	const arg1: IMinArgument = {
// 	// 		name: 'access',
// 	// 		description: 'access some shit'
...
// 	// 		description: 'install a package from npm',
// 	// 		CommandType: comtype.id,
// 	// 		Arguments: [carg1.id, carg2.id, carg3.id]
// 	// 	}
// 	// 	await commandService.createOne(install)

// 	// 	await argumentService.deleteOne({name: carg3.name})

// 	// 	const carg1exist = await Command.exists({
// 	// 		Arguments: carg1.id
// 	// 	})
// 	// 	const carg2exist = await Command.find({
// 	// 		Arguments: carg2.id
// 	// 	})
// 	// 	const carg3exist = await Command.find({
// 	// 		Arguments: carg3.id
	
// 	// 	})

// 	// 	expect(carg1exist).toBeTruthy()
// 	// 	expect(carg2exist).toBeTruthy()
// 	// 	expect(carg3exist).toBeFalsy()
